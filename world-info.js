...
for (let i = 0; i < paths.length; i++) {
    paths[i].addEventListener("click", function(event) {
        ...
        modalImg.src = countryInfo[country].image;
...
const countryInfo = {
    ...
    Afghanistan: {
        information: "Afghanistan is a landlocked country located in South Asia and Central Asia. It has been in a state of political and economic turmoil for decades. Kabul is the capital and largest city of Afghanistan.",
    ...
    Australia: {
        information: "Australia is a country located in the southern hemisphere, comprising the mainland of the Australian continent, the island of Tasmania, and numerous smaller islands. Canberra is the capital and Sydney is the largest city of Australia.",
        image: ""
    },
    Austria: {
    ...
    Brazil: {
    information: "Brazil is the largest country in South America and the fifth largest country in the world by both area and population. It is known for its diverse culture, with Portuguese influences. Brazil's capital is Brasília, and its largest city is São Paulo.",
    image: ""
    },
    Brunei: {
    ...
    Canada: {
    information: "Canada is a country in North America, and it is the second-largest country in the world by total area. The official languages are English and French. Ottawa is the capital and Toronto is the largest city of Canada.",
    image: ""
    }, 
    "Cape Verde": {
    ...
    DRC: {
    information: "The Democratic Republic of the Congo is a country in Central Africa bordered to the west by the South Atlantic Ocean. By area, the DRC is the second-largest country in Africa and the 11th-largest in the world.",
    image: ""
    },
    "Costa Rica": {
    ...
    Egypt: {
    information: "Egypt is a country located in North Africa and Southwest Asia. Cairo is its capital and largest city. Egypt is known for its ancient civilization and landmarks such as the Great Sphinx and the pyramids.",
    image: ""
    },
    "El Salvador": {
    ...
    CôtedIvoire: {
    information: "Ivory Coast, officially the Republic of Côte d'Ivoire, is a country located in West Africa. It gained independence from France in 1960. It is a unitary semi-presidential constitutional republic, Yamoussoukro and Abidjan are its capital",
    image: ""
    },
    Jamaica: {
    ...
    Mexico: {
    information: "Mexico is a country located in N.America. It is known for its ancient civilizations, such as the Aztecs and the Maya, and its diverse landscapes, such as deserts, rainforests, and beaches. Mexico City is its capital & largest city.",
    ...
    Russia: {
    information: "Russia is a country located in Eastern Europe and Northern Asia. It is the largest country in the world by land area, and Moscow is its capital and largest city. The official language is Russian and the government is a federal semi-presidential republic.",
    image: ""
    },
    Rwanda: {
    ...
    SouthAfrica: {
    information: "South Africa is a country located in Southern Africa. It gained independence from the United Kingdom in 1910. South Africa. Pretoria , Cape Town and Bloemfontein are its three capital cities.",
    image: ""
    },
    SouthSudan: {
    ...
    Cyprus: {
    information: "Cyprus, officially the Republic of Cyprus, is an island country located south of the Anatolian Peninsula in the eastern Mediterranean Sea. It is geographically in Western Asia, but its cultural ties and geopolitics are overwhelmingly Southeastern European.",
    image: ""
    },
    Cyprus2: {
    information: "Cyprus, officially the Republic of Cyprus, is an island country located south of the Anatolian Peninsula in the eastern Mediterranean Sea. It is geographically in Western Asia, but its cultural ties and geopolitics are overwhelmingly Southeastern European.",
    ...
    Malta: {
    information: "Malta is an archipelago in the central Mediterranean between Sicily and the North African coast. It's a nation known for historic sites related to a succession of rulers including the Romans, Moors, Knights of Saint John, French and British.",
    image: ""
    },
    Malta2: {
    information: "Malta is an archipelago in the central Mediterranean between Sicily and the North African coast. It's a nation known for historic sites related to a succession of rulers including the Romans, Moors, Knights of Saint John, French and British.",
    ...
    "New Caledonia": {
    information: "New Caledonia is a French territory comprising dozens of islands in the South Pacific. It's known for its palm-lined beaches and marine-life-rich lagoon, which, at 24,000-sq.-km, is among the world's largest. A massive barrier reef surrounds the main island, Grand Terre, a major scuba-diving destination. The capital, Nouméa, is home to French-influenced restaurants and luxury boutiques selling Parisian fashions. ",
    image: ""
    },
    "Puerto Rico": {
    information: "Puerto Rico is a Caribbean island and unincorporated U.S. territory with a landscape of mountains, waterfalls and the El Yunque tropical rainforest. In San Juan, the capital and largest city, the Isla Verde area is known for its hotel strip, beach bars and casinos.",
    image: ""
    },
    "Cayman Islands": {
    information: "The Cayman Islands, a British Overseas Territory, encompasses 3 islands in the western Caribbean Sea. Grand Cayman, the largest island, is known for its beach resorts and varied scuba diving and snorkelling sites. ",
    image: ""
    },
    "British Virgin Islands": {
    information: "The British Virgin Islands, part of a volcanic archipelago in the Caribbean, is a British overseas territory. Comprising 4 main islands and many smaller ones, it's known for its reef-lined beaches and as a yachting destination.  ",
    image: ""
    },
    "United States Virgin Islands": {
    information: "The U.S. Virgin Islands are a group of Caribbean islands and islets. A U.S. territory, it's known for white-sand beaches, reefs and verdant hills. St. Thomas island is home to the capital, Charlotte Amalie.  ",
    image: ""
    },
    Guam: {
    information: "Guam is a U.S. island territory in Micronesia, in the Western Pacific. It's distinguished by tropical beaches, Chamorro villages and ancient latte-stone pillars. Guams WWII significance is on view at the War in the Pacific National Historical Park, whose sites include Asan Beach, a former battlefield.",
    image: ""
    },
    TurksAndCaicos: {
    information: "Turks and Caicos is an archipelago of 40 low-lying coral islands in the Atlantic Ocean, a British Overseas Territory southeast of the Bahamas. The gateway island of Providenciales, known as Provo, is home to expansive Grace Bay Beach, with luxury resorts, shops and restaurants.",
    image: ""
    },
    Anguilla: {
    information: "Anguilla, a British Overseas Territory in the Eastern Caribbean, comprises a small main island and several offshore islets. Its beaches range from long sandy stretches like Rendezvous Bay, overlooking neighboring Saint Martin island.",
    image: ""
    },
    Montserrat: {
    information: "Montserrat is a mountainous Caribbean island, part of the Lesser Antilles chain and a British Overseas Territory. Its Soufrière Hills volcano erupted in the 1990s, causing significant damage to the south of the island and leading to the creation of an exclusion zone. ",
    image: ""
    },
    Guadeloupe: {
    information: "Guadeloupe, a French overseas region, is an island group in the southern Caribbean Sea. Resembling a butterfly, its 2 largest islands are separated by the Salée River. Hilly Grande-Terre Island has long beaches and sugarcane fields.",
    image: ""
    },
    Dominica: {
    information: "Dominica is a mountainous Caribbean island nation with natural hot springs and tropical rainforests. Morne Trois Pitons National Park is home to the volcanically heated, steam-covered Boiling Lake. The park also encompasses sulphur vents, the 65m-tall Trafalgar Falls and narrow Titou Gorge.",
    image: ""
    },
    Martinique: {
    information: "Martinique is a rugged Caribbean island that’s part of the Lesser Antilles. An overseas region of France, its culture reflects a distinctive blend of French and West Indian influences. Its largest town, Fort-de-France, features steep hills, narrow streets and La Savane, a garden bordered by shops and cafes. ",
    image: ""
    },
    Aruba: {
    information: "Aruba, officially the Country of Aruba is a constituent country of the Kingdom of the Netherlands physically located in the mid-south of the Caribbean Sea, about 29 kilometres north of the Venezuela peninsula of Paraguaná and 80 kilometres northwest of Curaçao.",
    image: ""
    },
    Curacao: {
    information: "Curaçao, a Dutch Caribbean island, is known for its beaches tucked into coves and its expansive coral reefs rich with marine life. The capital, Willemstad, has pastel-colored colonial architecture, floating Queen Emma Bridge and the sand-floored, 17th-century Mikvé Israel-Emanuel Synagogue. It’s also a gateway to western beaches like Blue Bay, a popular diving site",
    image: ""
    },
    "Saint Martin": {
    information: "Saint Martin is part of the Leeward Islands in the Caribbean Sea. It comprises 2 separate countries, divided between its northern French side, called Saint-Martin, and its southern Dutch side, Sint Maarten",
    image: ""
    },
    "Sint Maarten": {
    information: "Sint Maarten, part of the Kingdom of the Netherlands, is a country on the southern part of a Caribbean island shared with Saint Martin, a French overseas collectivity. Its natural features span lagoons, beaches and salt pans. ",
    image: ""
    },
    "Saint Barthelemy": {
    information: "Saint Barthelemy, a French-speaking Caribbean island commonly known as St. Barts, is known for its white-sand beaches and designer shops. The capital, Gustavia, encircling a yacht-filled harbor",
    image: ""
    },
    "Saint Kitts and Nevis": {
    information: "Saint Kitts and Nevis is a dual-island nation situated between the Atlantic Ocean and Caribbean Sea. It's known for cloud-shrouded mountains and beaches. The larger of the 2 islands, Saint Kitts, is dominated by the dormant Mount Liamuiga volcano, home to a crater lake, green vervet monkeys and rainforest crisscrossed with hiking trails.",
    image: ""
    },
    "Saint Lucia": {
    information: "Saint Lucia is an Eastern Caribbean island nation with a pair of dramatically tapered mountains, the Pitons, on its west coast. Its coast is home to volcanic beaches, reef-diving sites, luxury resorts and fishing villages.",
    image: ""
    },
    "Saint Vincent And The Grenadines": {
    information: "St. Vincent and the Grenadines is a southern Caribbean nation comprising a main island, St. Vincent, and a chain of smaller islands. With yacht-filled harbors, chic private isles and volcanic landscapes, it’s known for its major sailing destinations such as reef-lined Bequia Island off Admiralty Bay",
    image: ""
    },
    "Caribbean Netherlands": {
    information: "The Caribbean Netherlands are the three public bodies of the Netherlands that are located in the Caribbean Sea. They consist of the islands of Bonaire, Sint Eustatius and Saba, although the term Caribbean Netherlands is sometimes used to refer to all of the islands in the Dutch Caribbean.",
    image: ""
    },
    "Canary Islands": {
    information: "The Canary Islands, a Spanish archipelago off the coast of northwestern Africa, are rugged volcanic isles known for their black- and white-sand beaches. Tenerife, the largest island, is dominated by the sometimes-snowy active volcano Mt. Teide, which has its own astronomical observatory and is part of Teide National Park.",
    image: ""
    },
    "Sao Tome and Principe": {
    information: "São Tomé and Príncipe, an African island nation close to the equator, is part of a volcano chain featuring striking rock and coral formations, rainforests and beaches. On the larger island, São Tomé, is the Lagoa Azul lagoon. Ôbo Natural Park, a biodiverse jungle preserve, covers much of São Tomé and is distinguished by Pico Cão Grande, a skyscraperlike volcanic rock.",
    image: ""
    },
